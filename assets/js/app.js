...
const $followerPanel = document.querySelector("[data-folower-panel]");
        ...
        if (data.length) {
            for (const item of data) {
                ...
                $followerCard.innerHTML = `<figure class="avatar-circle img-holder">
                                                <img src="${avatar_url}&s=64" loading="lazy" alt="${username}" width="56"
                                                    height="56" class="img-cover">
                                            </figure>
            ...
            $followerPanel.innerHTML = `<div class="error-content">
                                            <p class="title-1">Oops! :(</p>
...
const updateFollowing = function () {
    ...
    fetchData(followingUrl, function (data) {
        ...
        if (data.length) {
            ...
            $followingPanel.innerHTML = `<div class="error-content">
                                            <p class="title-1">Oops! :(</p>
